...
public class UIButton extends LinearLayout {
	...
	public UIButton(Context context, AttributeSet attrs) {
		...
		mTitle = a.getString(R.styleable.UIButton_ui_title);
		mSubtitle = a.getString(R.styleable.UIButton_ui_subtitle);
		mImage = a.getResourceId(R.styleable.UIButton_ui_image, -1);
